...
**Estado:** fase 1 completada; fases 2–4 pendientes. La configuración y los tipos que aparecen abajo son el contrato propuesto.
...
| 2. Selector | Añadir la decisión de frecuencia, afinidad y rotación a una función pura con estado por stream. | Con aleatoriedad controlada se comprueban probabilidades, reparto entre sets y ausencia de duplicados recientes. |
...
- [ ] La selección respeta las probabilidades, la afinidad contextual, la rotación reciente y los límites de mensajes caóticos.
- [ ] La regla de uno, dos o tres emotes caóticos se aplica después del sorteo de frecuencia y no duplica IDs dentro del mensaje.
